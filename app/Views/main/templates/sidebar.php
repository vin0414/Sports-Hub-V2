    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item <?= ($title == 'Live Stream') ? 'active' : '' ?>">
                    <a class="nav-link" href="<?=site_url('videos/live-stream')?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <li class="nav-item <?= ($title == 'Upload') ? 'active' : '' ?>">
                    <a class="nav-link" href="<?=site_url('videos/upload')?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <span class="nav-link-title"> Upload Video </span>
                    </a>
                </li>
                <?php endif; ?>
                <?php if($role['scoreboard']==1): ?>
                <li class="nav-item <?= ($title == 'Scoreboard') ? 'active' : '' ?>">
                    <a class="nav-link" href="<?=site_url('scoreboard')?>">
                        ...
                        <span class="nav-link-title"> Scoreboard</span>
                    </a>
                </li>
                <?php endif;?>
                <?php if($role['events']==1): ?>
                <li class="nav-item <?= ($title == 'New Event') ? 'active' : '' ?>">
                    <a class="nav-link" href="<?=site_url('events/create')?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="nav-item <?= ($title == 'Create Account') ? 'active' : '' ?>">
                    <a class="nav-link" href="<?=site_url('accounts/create')?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="nav-item <?= ($title == 'New Article') ? 'active' : '' ?>">
                    <a class="nav-link" href="<?=site_url('news/create')?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <span class="nav-link-title"> Create News</span>
                    </a>
                </li>
                <?php endif; ?>
                <li class="nav-item mt-3">
                ...
                <?php if($role['maintenance']==1): ?>
                <li class="nav-item <?= ($title == 'Recovery') ? 'active' : '' ?>">
                    <a class="nav-link" href="<?=site_url('recovery')?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <span class="nav-link-title"> Back-Up & Restore </span>
                    </a>
                </li>
